...
const StateAnnotation = Annotation.Root({
  // 用户问题
  question: Annotation({ reducer: (_prev, next) => next, default: () => "" }),
  k: Annotation({ reducer: (_prev, next) => next, default: () => TOP_K }),
  // 检索到的相关文档片段
  documents: Annotation({ reducer: (_prev, next) => next, default: () => [] }),
  // 最终生成的答案
